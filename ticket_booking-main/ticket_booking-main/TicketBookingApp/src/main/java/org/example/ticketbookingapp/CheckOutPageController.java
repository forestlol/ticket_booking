...
public class CheckOutPageController {
    ...
    private void initialize() {
        try {
            ...
            // Listen for changes to the cart list
            carts.addListener((ListChangeListener.Change<? extends CartItem> change) -> {
                buyTicketButton.setDisable(carts.isEmpty());
            });

            // Initialize the button's disabled state correctly
            buyTicketButton.setDisable(carts.isEmpty());
    ...
    private void setupQuantityTextField() {
        quantityTextField.setText("1"); // Start with 1 as the default quantity
    ...
    private void adjustQuantity(int delta) {
        ...
        if (quantity < 0) {
            ...
            quantity = 5; // This enforces the maximum limit of 5
        }
